export type Language = 'en' | 'zu' | 'xh' | 'af' | 'st' | 'tn' | 'ts' | 've' | 'ss' | 'nr' | 'nso';
...
export const languageNames: Record<Language, string> = {
  en: 'English', zu: 'isiZulu', xh: 'isiXhosa', af: 'Afrikaans', st: 'Sesotho', tn: 'Setswana', ts: 'Xitsonga', ve: 'Tshivenda', ss: 'SiSwati', nr: 'isiNdebele', nso: 'Sepedi',
};

export const languageFlags: Record<Language, string> = {
  en: '🇬🇧', zu: '🇿🇦', xh: '🇿🇦', af: '🇿🇦', st: '🇿🇦', tn: '🇿🇦', ts: '🇿🇦', ve: '🇿🇦', ss: '🇿🇦', nr: '🇿🇦', nso: '🇿🇦',
};